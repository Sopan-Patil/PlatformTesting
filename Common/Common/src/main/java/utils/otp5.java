...
public class otp5 {
    ...
    private String userName = "Sopan.Patil@scispl.com";// provide user name
    private String password = "Welcome2020!";// provide password
    private String saveDirectory = System.getProperty("user.dir") + "\\SaveEmails";
 
 
    @Test
    public void main1() {
        otp5 sample = new otp5();
        sample.readMails();
    }
    ...
    public void readMails() {
        ...
        System.out.println("dire"+saveDirectory);
        try {
